...
class ReorderableAnimatedContainer extends AnimatedContainer {
  ...
  @override
  AnimatedWidgetBaseState<ReorderableAnimatedContainer> createState() {
    return BookShelfAnimatedContainerState();
  }
}

class BookShelfAnimatedContainerState
    extends AnimatedWidgetBaseState<ReorderableAnimatedContainer> {
