...
typedef ReorderableDragAnchorStrategy = Offset Function(
    ReorderableDraggable<Object> draggable,
    BuildContext context,
    Offset position);

Offset childDragAnchorStrategy(ReorderableDraggable<Object> draggable,
    BuildContext context, Offset position) {
  final renderObject = context.findRenderObject()! as RenderBox;
  return renderObject.globalToLocal(position);
}

Offset pointerDragAnchorStrategy(ReorderableDraggable<Object> draggable,
    BuildContext context, Offset position) {
  return Offset.zero;
}

class ReorderableDraggable<T extends Object> extends StatefulWidget {
  /// Creates a widget that can be dragged to a [ReorderableDragTarget].
  ///
  ...
  /// event, see [ReorderableDraggable.affinity].
  final Axis? axis;
  ...
  /// at the location of the [ReorderableDraggable] itself when a drag is under way.
  ...
  ///
  /// This property's value is a function that implements [ReorderableDragAnchorStrategy].
  ...
  final ReorderableDragAnchorStrategy? dragAnchorStrategy;
  ...
  /// starts, see [ReorderableDraggable.axis].
  final Axis? affinity;
  ...
  /// Called when the draggable is dropped without being accepted by a [ReorderableDragTarget].
  ///
  ...
  /// Called when the draggable is dropped and accepted by a [ReorderableDragTarget].
  ///
  /// This function might be called after this widget has been removed from the
  /// tree. For example, if a drag was in progress when this widget was removed
  ...
  /// `details` is whether the draggable's [ReorderableDragTarget] accepted it.
  ///
  /// This function will only be called while this widget is still mounted to
  ...
  @override
  State<ReorderableDraggable<T>> createState() =>
      _ReorderableDraggableState<T>();
}

class ReorderableLongPressDraggable<T extends Object>
    extends ReorderableDraggable<T> {
  /// Creates a widget that can be dragged starting from long press.
  ///
  /// The [child] and [feedback] arguments must not be null. If
  /// [maxSimultaneousDrags] is non-null, it must be non-negative.
  const ReorderableLongPressDraggable({
    Key? key,
    ...
    ReorderableDragAnchorStrategy? dragAnchorStrategy,
...
class _ReorderableDraggableState<T extends Object>
    extends State<ReorderableDraggable<T>> {
  @override
  void initState() {
    super.initState();
  ...
  _BookShelfDragAvatar<T>? _startDrag(Offset position) {
    ...
    final avatar = _BookShelfDragAvatar<T>(
...
class ReorderableDragTarget<T extends Object> extends StatefulWidget {
  /// Creates a widget that receives drags.
  ///
  /// The [builder] argument must not be null.
  const ReorderableDragTarget({
    Key? key,
  ...
  /// Called when a [ReorderableDraggable] moves within this [ReorderableDragTarget].
  ///
  ...
  @override
  State<ReorderableDragTarget<T>> createState() =>
      _ReorderableDragTargetState<T>();
}
...
class _ReorderableDragTargetState<T extends Object>
    extends State<ReorderableDragTarget<T>> {
  ...
  @override
  void didUpdateWidget(covariant ReorderableDragTarget<T> oldWidget) {
...
class _BookShelfDragAvatar<T extends Object> extends Drag {
  ...
  _ReorderableDragTargetState<Object>? _activeTarget;
  final List<_ReorderableDragTargetState<Object>> _enteredTargets =
      <_ReorderableDragTargetState<Object>>[];
  Offset _position;
  Offset? _lastOffset;
  OverlayEntry? _entry;
  ...
  void updateDrag(Offset globalPosition) {
    ...
    // Enter new targets.
    final newTarget =
        targets.cast<_ReorderableDragTargetState<Object>?>().firstWhere(
      (target) {
  ...
  Iterable<_ReorderableDragTargetState<Object>> _getDragTargets(
    ...
    for (final entry in path) {
      ...
      if (target is RenderMetaData) {
        ...
        if (metaData is _ReorderableDragTargetState &&
