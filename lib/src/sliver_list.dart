...
class RenderSuperSliverList extends RenderSliverMultiBoxAdaptor {
  ...
  void performLayout() {
    ...
    var index = firstChild != null ? indexOf(firstChild!) : 0;
    ...
    while (indexOf(firstChild!) > 0 &&
      ...
      if (!_layoutOffsetIsEstimated ||
        ...
        final correction = paintExtentOf(box) - extent;
    ...
    if (indexOf(firstChild!) > 0 &&
      ...
      _layoutOffsetIsEstimated = true;
      final correctedOffset = indexOf(firstChild!) * extent;
      final correction = correctedOffset - childScrollOffset(firstChild!)!;
